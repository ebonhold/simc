...
void fury( player_t* p )
{
  ...
  slayer->add_action( "bloodthirst,if=(talent.reckless_abandon&buff.recklessness.up)&(buff.bloodcraze.stack>=1|(talent.uproar&dot.bloodbath_dot.remains<40&talent.bloodborne)|buff.enrage.up&buff.enrage.remains<gcd)" );
  ...
  slayer->add_action( "bloodthirst,if=(talent.reckless_abandon&buff.recklessness.up)&(buff.bloodcraze.stack>=4|crit_pct_current>=85|active_enemies>2)" );
  slayer->add_action( "crushing_blow" );
  slayer->add_action( "bloodthirst,if=talent.reckless_abandon&buff.recklessness.up" );
  ...
  thane->add_action( "bloodthirst,if=(talent.reckless_abandon&buff.recklessness.up)&(buff.bloodcraze.stack>=2)" );
  ...
  thane->add_action( "bloodthirst,if=talent.reckless_abandon&buff.recklessness.up" );
