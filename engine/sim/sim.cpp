...
void sim_t::create_options()
{
  ...
  add_option( opt_bool( "dragonflight.manic_grieftorch_deaths", dragonflight_opts.manic_grieftorch_deaths ) );
  add_option( opt_uint( "dragonflight.manic_grieftorch_cooldown", dragonflight_opts.manic_grieftorch_cooldown, 30, 120 ) );
}
